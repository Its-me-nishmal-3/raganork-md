...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/JsbTohb.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Nextronize;Its-me-nishmal;0;https://i.imgur.com/JsbTohb.jpeg;https://whatsapp.com/channel/0029VaoLP4N5EjxqmXXJ6R3K',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Nextronize",
    BOT_NAME: process.env.BOT_NAME || 'Nextronize',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Its-me-nishmal;Nextronize MD bot;https://i.imgur.com/JsbTohb.jpeg' : process.env.AUDIO_DATA,
